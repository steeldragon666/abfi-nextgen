...
describe('Volume Security Scoring', () => {
  ...
  it('should score 100 for 150%+ coverage', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 15000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
    ];
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 80 };
  ...
  it('should score 85 for 120-149% coverage', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 12000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
    ];
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 80 };
  ...
  it('should score 70 for 100-119% coverage', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 10000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
    ];
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 80 };
  ...
  it('should combine Tier 1 and Tier 2 volumes', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 7000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
      { id: 2, tier: 'tier2', annualVolume: 5000, contractLength: 7, priceStructure: 'indexed', takeOrPay: false, supplierId: 2 },
    ];
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 80 };
  ...
  it('should ignore Options and ROFR tiers', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 8000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
      { id: 2, tier: 'options', annualVolume: 5000, contractLength: 5, priceStructure: 'indexed', takeOrPay: false, supplierId: 2 },
    ];
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 80 };
...
describe('Counterparty Quality Scoring', () => {
  const calculateCounterpartyQualityScore = (
    ...
    for (const agreement of agreements) {
      const qual = qualifications.find(q => q.supplierId === agreement.supplierId);
      let supplierScore = 50; // Default for unqualified
      
      if (qual) {
        switch (qual.level) {
          case 'GQ1': supplierScore = 100; break;
          case 'GQ2': supplierScore = 85; break;
          case 'GQ3': supplierScore = 70; break;
          case 'GQ4': supplierScore = 55; break;
        }
      }
  ...
  it('should score 100 for all GQ1 suppliers', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 5000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
      { id: 2, tier: 'tier1', annualVolume: 5000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 2 },
    ];
  ...
  it('should calculate weighted average for mixed qualifications', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 6000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 }, // 60%
      { id: 2, tier: 'tier1', annualVolume: 4000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 2 }, // 40%
    ];
    const qualifications: GrowerQualification[] = [
...
describe('Contract Structure Scoring', () => {
  const calculateContractStructureScore = (agreements: SupplyAgreement[]): number => {
    if (agreements.length === 0) return 0;
  ...
  it('should score lower for shorter contracts', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 10000, contractLength: 5, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
    ];
  ...
  it('should score lower for indexed pricing', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 10000, contractLength: 10, priceStructure: 'indexed', takeOrPay: true, supplierId: 1 },
    ];
  ...
  it('should score lower without take-or-pay', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 10000, contractLength: 10, priceStructure: 'fixed', takeOrPay: false, supplierId: 1 },
    ];
  ...
  it('should calculate weighted average for multiple contracts', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 7000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 }, // 70%, score 100
      { id: 2, tier: 'tier1', annualVolume: 3000, contractLength: 5, priceStructure: 'indexed', takeOrPay: false, supplierId: 2 }, // 30%, score 40
    ];
...
describe('Concentration Risk Scoring (HHI)', () => {
  const calculateConcentrationRiskScore = (agreements: SupplyAgreement[]): number => {
    if (agreements.length === 0) return 0;
  ...
  it('should score 100 for low concentration (HHI < 1500)', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 2500, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
      { id: 2, tier: 'tier1', annualVolume: 2500, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 2 },
      { id: 3, tier: 'tier1', annualVolume: 2500, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 3 },
      { id: 4, tier: 'tier1', annualVolume: 2500, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 4 },
    ];
  ...
  it('should score better for well-distributed supply', () => {
    const agreements: SupplyAgreement[] = [
      { id: 1, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 1 },
      { id: 2, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 2 },
      { id: 3, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 3 },
      { id: 4, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 4 },
      { id: 5, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 5 },
      { id: 6, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 6 },
      { id: 7, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 7 },
      { id: 8, tier: 'tier1', annualVolume: 1000, contractLength: 10, priceStructure: 'fixed', takeOrPay: true, supplierId: 8 },
    ];
...
describe('Operational Readiness Scoring', () => {
  ...
  it('should return the operational readiness value directly', () => {
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 85 };
    const score = calculateOperationalReadinessScore(project);
    expect(score).toBe(85);
  });

  it('should handle low operational readiness', () => {
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 30 };
    const score = calculateOperationalReadinessScore(project);
    expect(score).toBe(30);
  });

  it('should handle perfect operational readiness', () => {
    const project: Project = { annualFeedstockVolume: 10000, operationalReadiness: 100 };
    const score = calculateOperationalReadinessScore(project);
    expect(score).toBe(100);
  });
});
